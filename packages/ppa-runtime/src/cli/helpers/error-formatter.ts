...
export function checkProviderStreamDisconnectError(
  ...
  return `${provider} closed the streaming connection before completing the response. PPA Runtime retries this automatically when it is safe; if it keeps happening, retry or switch models with /model.`;
}
