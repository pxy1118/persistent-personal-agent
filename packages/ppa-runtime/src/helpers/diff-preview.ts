...
type DiffDeps = {
  ...
  isFileWriteTool: typeof import("@/cli/helpers/tool-name-mapping").isFileWriteTool;
  isFileEditTool: typeof import("@/cli/helpers/tool-name-mapping").isFileEditTool;
  isPatchTool: typeof import("@/cli/helpers/tool-name-mapping").isPatchTool;
  parsePatchOperations: typeof import("@/cli/helpers/format-args-display").parsePatchOperations;
};
...
async function getDiffDeps(): Promise<DiffDeps> {
  ...
  const [diffMod, toolNameMod, formatMod] = await Promise.all([
    ...
    import("@/cli/helpers/tool-name-mapping"),
    import("@/cli/helpers/format-args-display"),
  ]);
  cachedDiffDeps = {
